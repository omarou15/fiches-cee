# BAR-TH-141 - BAR-TH-141 vA71-2 à compter du 01-08-2025 : Climatiseur performant (France d'outre-mer) PDF – 115.47 Ko
- Secteur: residentiel
- Famille: TH
- Version: vA71-2
...
## Documents sources
- `Residentiel_BAR/BAR-TH-141 vA71-2 à compter du 01-08-2025.pdf`
- `Residentiel_BAR/BAR-TH-141 vA71-2 à compter du 01-08-2025 - Partie A.pdf`
- `Residentiel_BAR/BAR-TH-141 vA71-2 à compter du 01-08-2025 - Partie A à compter du 01-07-2026.pdf`
...
- Remplacement d’un climatiseur existant par un climatiseur fixe, de classe d’efficacité énergétique supérieure ou
- Le climatiseur est de classe A à A+++, selon la classification définie dans le règlement délégué (UE) n° 626/2011
- 3 - sa puissance frigorifique et sa classe d’efficacité énergétique ou le SEER*.
- établi dans l’Espace économique européen et accrédité selon la norme NF EN 45011 par le Comité français
- frigorifique et sa classe d’efficacité énergétique ou à défaut le coefficient d’efficacité énergétique saisonnier (SEER)
- permettant de déterminer la classe d’efficacité énergétique du climatiseur installé.
- Classe A
- Classe A+
- Classe A++
- Classe A+++
...
- Par dérogation aux points 2 et 3 ci-dessus, la preuve de réalisation de l’opération mentionne la mise en place d’un
- équipement avec ses marque et référence et elle est complétée par un document issu du fabricant ou d’un organisme
...
3. Conditions pour la délivrance de certificats
Le climatiseur est de classe A à A+++, selon la classification définie dans le règlement délégué (UE) n° 626/2011
de la Commission Européenne du 4 mai 2011, individuel (monosplit) ou regroupé (multisplit).
...
Dans le cas où le bénéficiaire remplace dans un logement des climatiseurs existants par plusieurs climatiseurs de
caractéristiques et classe d’efficacité identiques, le montant des certificats d’économies d’énergie, calculé par
climatiseur, est multiplié par le nombre de climatiseurs.
