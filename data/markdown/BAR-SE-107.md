# BAR-SE-107 - BAR-SE-107 vA37-1 à compter du 31-12-2020 : Abaissement de la température de retour vers un réseau de chaleur PDF – 118.45 Ko
- Secteur: residentiel
- Famille: SE
- Version: vA37-1
- Date d'application: 2020-12-31

## Documents sources
- `Residentiel_BAR/BAR-SE-107 vA37-1 à compter du 31-12-2020_0.pdf`
- `Residentiel_BAR/BAR-SE-107 vA37-1 à compter du 31-12-2020 - Parties A et D.pdf`
- `Residentiel_BAR/BAR-SE-107 vA37-1 à compter du 31-12-2020 - Partie A à compter du 01-07-2026 et Partie D.pdf`
...
Opération n° BAR-SE-107

Abaissement de la température de retour vers un réseau de chaleur

1. Secteur d’application
Bâtiments résidentiels existants raccordés à un réseau de chaleur existant en France métropolitaine.
...
Pour l’abaissement de la température de retour vers le réseau de chaleur, trois types d’interventions sont possibles
sur la (ou les) sous-station(s) du bénéficiaire :
- la suppression de l’ensemble des points de recyclage dans la sous-station raccordée au réseau de chaleur ;
- ou la suppression de l’ensemble des points de recyclage et l’équilibrage de l’ensemble des sous-stations raccordées
au réseau de chaleur ;
- ou la suppression de l’ensemble des points de recyclage et l’équilibrage de l’ensemble des sous-stations implantées
sur le circuit secondaire de distribution de la chaleur concernées par l’opération.
